...
The two-board rig has been measured, not just listened to: 2,784,000 consecutive
frames delivered from an Android phone to a Mac through both boards, **identical
to the source file, sample for sample**. See `rp2040/TESTING.md` and
`tools/bitcompare.py`.
